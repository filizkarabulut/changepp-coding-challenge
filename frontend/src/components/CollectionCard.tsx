...
export function CollectionCard({
  ...
  return (
    <Card className="group relative flex flex-col overflow-hidden transition-all duration-200 hover:shadow-lg">
      ...
      {/* Hover overlay — scoped to the thumbnail area only so the text area
          below is never darkened. Buttons appear bottom-right of the image. */}
      <div className="pointer-events-none absolute inset-x-0 top-0 h-44 flex items-end justify-end bg-gradient-to-t from-black/60 via-black/10 to-transparent p-3 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
